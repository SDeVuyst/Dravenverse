...
(function () {
	...
	$(function () {
			...
			$.getScript('//maps.google.com/maps/api/js?'+ ( key ? 'key='+ key + '&' : '' ) +'sensor=false&libraries=geometry,places&v=quarterly', function () {
				...
				for (var i = 0; i < plugins.maps.length; i++) {
					...
					var map = new google.maps.Map(plugins.maps[i].querySelectorAll(".google-map")[0], {
						...
						styles: styles,
						scrollwheel: false,
						center: {lat: 32.72032424351302 , lng: -117.1605972485596}
					});
		...
		var d3Charts = [];
		var barChartObjectData = [4.4, 4.6, 4.4, 4.8, 5.4, 5.6, 6.1],
			barChartObject = {
				bindto: '#bar-chart',
				legend: {
					show: false
				...
				data: {
					x: 'x',
					columns: [
						['x', '2012-01-01', '2013-01-01', '2014-01-01', '2015-01-01', '2016-01-01', '2017-01-01', '2018-01-01'],
